...
public class ResumeLocalRepertory implements IResumeModel {

    @Override
    public void getResumeData(ResumeRequest resumeRequest, OnRequestResponse<ResumeDatas> onRequestResponse) {
